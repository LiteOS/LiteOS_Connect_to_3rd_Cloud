...
int MqttSample_CmdSavedata11(struct MqttSampleContext *ctx){
    int err;
    struct MqttExtent *ext;
	uint16_t pkt_id = 1; 
...
int MqttSample_CmdSavedata01(struct MqttSampleContext *ctx){
...
int MqttSample_CmdSavedata07(struct MqttSampleContext *ctx){
    int err;
    struct MqttExtent *ext;
...
int MqttSample_CmdSavedata17(struct MqttSampleContext *ctx){
    /*
    int err = 0;
    int64_t ts;
