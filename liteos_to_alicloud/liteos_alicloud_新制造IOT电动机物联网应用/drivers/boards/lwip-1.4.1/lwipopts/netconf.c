...
/* Private typedef -----------------------------------------------------------*/
#define MAX_DHCP_TRIES        6 /** Change 4 to 6 */
...
extern volatile u8_t uDeviceStateDHCP;  /** DHCP getted ip */
...
void LwIP_DHCP_task(void * pvParameters)
{
  ...
  struct ip_addr gw;
	...
	while(1)
	{
		...
		case DHCP_WAIT_ADDRESS:
			{
				...
				if (IPaddress!=0) 
				{
                    ...
                    uDeviceStateDHCP = 0x01; /** DHCP get IP */
		...
		LOS_TaskDelay(250); // 250 tick means 250ms.		
	}
}
#endif
