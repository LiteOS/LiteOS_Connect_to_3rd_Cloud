...
* @{
*/
/** @2018-04-24 BugFixed TY IAR need #pragma pack(4) instead of __align(4) */ 
...
void ETH_Delay(__IO uint32_t nCount)
{
  ...
  /* @2018-04-24 If no defined, then Printf */
//  #ifndef uint32_t
//      #error "uint32_t is not defined, you have to define it in your stm32f429_eth.c"
//  #endif
}
#endif /* USE_Delay*/
