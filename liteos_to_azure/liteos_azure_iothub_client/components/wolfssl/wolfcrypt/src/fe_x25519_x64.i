 ...
 */
INLINE void fe_cswap_int(fe a, fe b, int c)
{
    __asm__ __volatile__ (
        "movslq	%[c], %%rax\n\t"
        "movq	0(%[a]), %%rcx\n\t"
 ...
 * b  A field element.
 */
INLINE void fe_sub_int(fe r, const fe a, const fe b)
{
    __asm__ __volatile__ (
 ...
 * b  A field element.
 */
INLINE void fe_add_int(fe r, const fe a, const fe b)
{
    __asm__ __volatile__ (
        "movq	0(%[a]), %%rax\n\t"
        "movq	8(%[a]), %%rdx\n\t"
...
#ifdef HAVE_INTEL_AVX2
INLINE void fe_mul_avx2(fe r, const fe a, const fe b)
{
    __asm__ __volatile__ (
        "#  A[0] * B[0]\n\t"
        "movq   0(%[b]), %%rdx\n\t"
...
INLINE void fe_mul_x64(fe r, const fe a, const fe b)
{
    __asm__ __volatile__ (
        "#  A[0] * B[0]\n\t"
        "movq   0(%[b]), %%rax\n\t"
...
#ifdef HAVE_INTEL_AVX2
INLINE void fe_sq_avx2(fe r, const fe a)
{
    __asm__ __volatile__ (
        "# A[0] * A[1]\n\t"
        "movq   0(%[a]), %%rdx\n\t"
...
INLINE void fe_sq_x64(fe r, const fe a)
{
    __asm__ __volatile__ (
        "#  A[0] * A[1]\n\t"
        "movq   0(%[a]), %%rax\n\t"
 ...
 * b  A field element.
 */
INLINE void fe_mul121666_int(fe r, fe a)
{
    __asm__ __volatile__ (
        "movq	$0x7fffffffffffffff, %%rcx\n\t"
        "movq	$121666, %%rax\n\t"
...
#ifdef HAVE_INTEL_AVX2
INLINE void fe_sq2_avx2(fe r, const fe a)
{
    __asm__ __volatile__ (
        "# A[0] * A[1]\n\t"
        "movq   0(%[a]), %%rdx\n\t"
...
INLINE void fe_sq2_x64(fe r, const fe a)
{
    __asm__ __volatile__ (
        "#  A[0] * A[1]\n\t"
        "movq   0(%[a]), %%rax\n\t"
