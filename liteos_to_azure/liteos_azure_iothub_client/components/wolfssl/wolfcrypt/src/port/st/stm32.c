...
/* User can override STM32_HASH_CLOCK_ENABLE and STM32_HASH_CLOCK_DISABLE */
    ...
    INLINE void wc_Stm32_Hash_Clock_Enable(STM32_HASH_Context* stmCtx)
    {
    #if 0//def WOLFSSL_STM32_CUBEMX
    ...
    INLINE void wc_Stm32_Hash_Clock_Disable(STM32_HASH_Context* stmCtx)
    {
    #if 0//def WOLFSSL_STM32_CUBEMX
...
INLINE void wc_Stm32_Hash_SaveContext(STM32_HASH_Context* ctx)
{
    int i;
...
INLINE int wc_Stm32_Hash_RestoreContext(STM32_HASH_Context* ctx)
{
    int i;
...
INLINE void wc_Stm32_Hash_GetDigest(byte* hash, int digestSize)
{
...
INLINE int wc_Stm32_Hash_WaitDone(void)
{
