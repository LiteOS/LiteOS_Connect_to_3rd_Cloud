...
#if !defined(WOLFSSL_OPTIONS_IGNORE_SYS)
    struct tm {
...
/* forward declarations */
    ...
    extern time_t get_time(time_t* p);
    #define XTIME(tl)       get_time((tl))
#endif
