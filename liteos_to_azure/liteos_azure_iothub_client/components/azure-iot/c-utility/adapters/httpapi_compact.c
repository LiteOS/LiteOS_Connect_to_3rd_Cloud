...
HTTP_HANDLE HTTPAPI_CreateConnection(const char* hostName)
{
    ...
    {
        http_instance = (HTTP_HANDLE_DATA*)platform_malloc(sizeof(HTTP_HANDLE_DATA));
...
void HTTPAPI_CloseConnection(HTTP_HANDLE handle)
{
    ...
    if (http_instance != NULL)
    {
        ...
        {
            platform_free(http_instance->certificate);
        }
        ...
        {
            platform_free(http_instance->x509ClientCertificate);
        }
        ...
        {
            platform_free(http_instance->x509ClientPrivateKey);
        }
        platform_free(http_instance);
    }
}
...
static void on_bytes_received(void* context, const unsigned char* buffer, size_t size)
{
    ...
    if (http_instance != NULL)
    {
        ...
        else
        {
            ...
            new_received_bytes = (unsigned char*)platform_realloc(http_instance->received_bytes, http_instance->received_bytes_count + size);
    ...
    else
    {
        ...
        while (result < count)
        {
            ...
            if (http_instance->received_bytes_count >= (size_t)count)
            {
                ...
                {
                    platform_free(http_instance->received_bytes);
                    http_instance->received_bytes = NULL;
                }
...
HTTPAPI_RESULT HTTPAPI_SetOption(HTTP_HANDLE handle, const char* optionName, const void* value)
{
    ...
    else if (strcmp("TrustedCerts", optionName) == 0)
    {
        ...
        http_instance->certificate = (char*)platform_malloc((len + 1) * sizeof(char));
        if (http_instance->certificate == NULL)
        {
    ...
    else if (strcmp(SU_OPTION_X509_CERT, optionName) == 0)
    {
        ...
        len = (int)strlen((char*)value);
        http_instance->x509ClientCertificate = (char*)platform_malloc((len + 1) * sizeof(char));
    ...
    else if (strcmp(SU_OPTION_X509_PRIVATE_KEY, optionName) == 0)
    {
        ...
        len = (int)strlen((char*)value);
        http_instance->x509ClientPrivateKey = (char*)platform_malloc((len + 1) * sizeof(char));
...
HTTPAPI_RESULT HTTPAPI_CloneOption(const char* optionName, const void* value, const void** savedValue)
{
    ...
    else if (strcmp("TrustedCerts", optionName) == 0)
    {
        ...
        tempCert = (char*)platform_malloc((certLen + 1) * sizeof(char));
        if (tempCert == NULL)
        {
