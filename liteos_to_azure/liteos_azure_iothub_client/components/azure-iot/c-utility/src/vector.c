...
VECTOR_HANDLE VECTOR_create(size_t elementSize)
{
    ...
    {
        result = (VECTOR*)platform_malloc(sizeof(VECTOR));
...
int VECTOR_push_back(VECTOR_HANDLE handle, const void* elements, size_t numElements)
{
    ...
    else
    {
        ...
        void* temp = platform_realloc(handle->storage, curSize + appendSize);
        if (temp == NULL)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        tmp = platform_realloc(handle->storage, (handle->elementSize * handle->count));
                        if (tmp == NULL)
                        {
